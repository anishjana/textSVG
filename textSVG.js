...
var SVGTextAnimate = (function () {
     ...
     * @return {string}
     */
    Path.prototype.toSVG = function (decimalPlaces, fillColor) {
        console.log("fill", fillColor)
        var svg = '<path fill="' + fillColor + '" d="';
    ...
    *****/
        ...
        SVGCreator.prototype.setPathAnimation = function setPathAnimation(path, i) {
            ...
            switch (_options.mode) {
                case "sync":
                    ...
                    break;
                case "delay":
                    animation += " begin=" + _options.delay * (i + 1) + "ms";
                    break;
                case "onebyone":
                    animation += " begin=" + _options["duration"] * i + "ms";
                    break;
                default:
                    animation += " begin=" + _options.mode;
                    break;
            }
            animation += " />";
     ...
     */
    SVGTextAnimate.prototype.setFontFromBuffer = function setFontFromBuffer(buffer) {
        this.font = parseBuffer(buffer);
        this.loaded = true;
        return this
    };
    ...
    SVGTextAnimate.prototype.createSVGDom = function createSVGDom(text) {
        ...
        paths.forEach(function (path) {
            console.log(path)
            svgpath += path.toSVG(2, path.fill);
        });
